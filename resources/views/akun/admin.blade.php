    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <a href="{{ route('register') }}" target="_blank"><button type="button" class="btn btn-success m-1 mb-3">Tambah
                        Akun</button></a>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-2">
                                        <form action="{{ route('destroyAkun', $admin->id) }}" method="POST">
                                            <a href="{{ route('editAkun', $admin->id) }}" class="me-2"
                                                style="text-decoration: none;">
                                                edit
                                            </a>

                                            <a href="{{ route('editPassword', $admin->id) }}"
