        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Edit Sub Topik</h5>
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('subtopik.update', $subtopik->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                            ...
                                            <select class="form-control" id="topik_id" name="topik_id" required>
                                                ...
                                                @foreach ($topiks as $topik)
                                                    <option value="{{ $topik->id }}"
                                                        {{ $subtopik->topik_id == $topik->id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="subtopik" name="subtopik"
                                                aria-describedby="subtopikHelp" value="{{ $subtopik->subtopik }}">
                                        </div>
