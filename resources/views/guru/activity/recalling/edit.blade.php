                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('recalling.update', $recalling->id) }}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="range" class="progress-bar" id="progressBar" name="indikator"
                                                value="{{ $recalling->indikator }}" min="0" max="100">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="notifikasi" name="notifikasi" rows="5">{{ $recalling->notifikasi }}</textarea>
                                        </div>
                                        @error('notifikasi')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
