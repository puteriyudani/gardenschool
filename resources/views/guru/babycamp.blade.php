                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row text-center">
                            <div class="col-md-4">
                                <div class="card">
                                    <a target="_blank" href="{{ route('tbwelcome.siswa') }}">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <a target="_blank" href="{{ route('tbmorning.siswa') }}">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <a target="_blank" href="{{ route('tbbreakfast.siswa') }}">
                        ...
                        <div class="row text-center">
                            <div class="col-md-4">
                                <div class="card">
                                    <a target="_blank" href="{{ route('tbislamic.siswa') }}">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <a target="_blank" href="{{ route('tbact.siswa') }}">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <a target="_blank" href="{{ route('tbfun.siswa') }}">
                        ...
                        <div class="row text-center">
                            <div class="col-md-4">
                                <div class="card">
                                    <a target="_blank" href="{{ route('tblunch.siswa') }}">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <a target="_blank" href="{{ route('tbrecalling.siswa') }}">
