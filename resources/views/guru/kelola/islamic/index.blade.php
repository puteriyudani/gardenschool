                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('hadistbaby.index') }}" target="_blank"><button type="button" class="btn btn-warning m-1">Hadist</button></a>
                            <a href="{{ route('quranbaby.index') }}" target="_blank"><button type="button" class="btn btn-success m-1">Al-Qur'an</button></a>
                            <a href="{{ route('doababy.index') }}" target="_blank"><button type="button" class="btn btn-primary m-1">Doa</button></a>
                        </div>
                    </div>
                </div>
            </div>
