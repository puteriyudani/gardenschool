...
@section('judul')
    <title>Montessory - Instagram</title>
@endsection
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h5 class="mb-4">Daftar Postingan Instagram</h5>
                <a href="{{ route('instagram.create') }}" class="btn btn-success mb-3">Tambah Data</a>

                <!-- Pilih Kelompok -->
                <div class="mb-3">
                    <strong>Pilih Kelompok:</strong>
                    @foreach ($kelompokList as $kelompok)
                        <a href="{{ route('instagram.index', ['kelompok' => $kelompok]) }}"
                ...
                <div class="table-responsive">
                    @foreach ($groupedInstagrams as $kelompok => $temaGroup)
                        ...
                        @foreach ($temaGroup as $tema => $topikGroup)
                            ...
                            @foreach ($topikGroup as $topik => $subtopikGroup)
                                ...
                                @foreach ($subtopikGroup as $subtopik => $instagrams)
                                        ...
                                        <tbody>
                                            @foreach ($instagrams as $instagram)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('instagram.edit', $instagram->id) }}"
                                                            class="btn btn-warning btn-sm">
                                                            Edit
                                                        </a>
                                                        <form action="{{ route('instagram.destroy', $instagram->id) }}"
                                                            method="POST"
